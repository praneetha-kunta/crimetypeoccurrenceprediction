...
ROOT_URLCONF = 'crime_typeand_occurrence_prediction.urls'
...
WSGI_APPLICATION = 'crime_typeand_occurrence_prediction.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'crime_typeand_occurrence_prediction',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
